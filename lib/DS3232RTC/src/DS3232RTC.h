...
#include <Arduino.h>
#include <TimeLib32.h>        // https://github.com/PaulStoffregen/Time
...
class DS3232RTC
{
    public:
        ...
        void begin();
        static time32_t get();    // static needed to work with setSyncProvider() in the Time library
        uint8_t set(time32_t t);
